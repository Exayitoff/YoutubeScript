...
class AddMeFast:
    ...
    def login_gmail(self):
        ...
        actions.send_keys("aimzemo3@gmail.com").perform()
        sleep(2)
        actions.send_keys(Keys.RETURN).perform()
        sleep(2)

        actions.send_keys("Ezozbek1").perform()
        sleep(2)
        actions.send_keys(Keys.RETURN).perform()
    ...
    def login_twitter(self):
        ...
        for _ in range(N):
            ...
            sleep(2)
        actions.send_keys("Ezozbek02877502").perform()
        sleep(2)
    ...
    #     )
    #     username.send_keys("zemocoder")

    #     password = WebDriverWait(self.browser, 10).until(
    #         EC.presence_of_element_located((By.NAME, "password"))
    #     )
    #     password.send_keys("Ezozbek2")
    #     sleep(2)
